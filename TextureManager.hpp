...
public:
    ...
    void DrawParticle(std::string id, int pos_x, int pos_y, int src_x, int src_y, int src_w, int src_h, int dst_w, int dst_h, Uint8 ttl, SDL_Renderer *renderer, bool alpha_ttl = false);
