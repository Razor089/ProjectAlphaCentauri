...
public:
    ...
    void DrawBackground(std::string id, int pos_x, int pos_y, int src_x, int src_y, int width, int height, int dst_width, int dst_height, SDL_Renderer *pRenderer, SDL_RendererFlip flip = SDL_FLIP_NONE);
