...
void MessageHandler::PrintColorText(SDL_Renderer *renderer, std::string message, std::string font_name, TextColor color, Vector position, int mode)
{
    int text_width;
    int text_height;
    ...
    SDL_Surface *surface;
    SDL_Texture *texture;
    SDL_Color text_color = { color.r, color.g, color.b, 0};
